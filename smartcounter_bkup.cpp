...
// Divider values actually populated
// Vadc = Vbat * (Rbottom / (Rtop + Rbottom))
static const float BATTERY_R_TOP_OHMS    = 33000.0f;
static const float BATTERY_R_BOTTOM_OHMS = 68000.0f;
...
static const uint32_t DEFAULT_POST_INTERVAL_SEC   = 300;
